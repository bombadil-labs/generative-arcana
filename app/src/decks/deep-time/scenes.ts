...
function drawBandTexture(p: P5, placement: SpreadScenePlacement, y: number, bandH: number, w: number, t: number, reducedMotion: boolean) {
  const family = familyOf(placement);
...
function drawFault(p: P5, placement: SpreadScenePlacement, count: number, w: number, h: number, t: number, reducedMotion: boolean) {
  const seed = hash(placement.card.slug);
...
function drawPlume(p: P5, placement: SpreadScenePlacement, count: number, w: number, h: number, t: number, reducedMotion: boolean) {
  const seed = hash(placement.card.slug);
...
function drawGrains(p: P5, placement: SpreadScenePlacement, count: number, w: number, h: number, t: number, reducedMotion: boolean) {
  const seed = hash(placement.card.slug);
...
function drawMajorEvent(p: P5, placement: SpreadScenePlacement, count: number, w: number, h: number, t: number, reducedMotion: boolean) {
  const seed = hash(placement.card.slug);
...
function drawColumnLabels(p: P5, placements: readonly SpreadScenePlacement[], count: number, w: number, h: number, hover: number) {
  const bandH = h / count;
