# Ranks — Prime Scaffold

Make the **fourth axis load-bearing** in the ranks: structure the numbered ranks by their prime/composite character so the arithmetic is visible in the rank meanings, not just latent in their numbers. Best when you want the prime logic echoing at both scales (pairs with `majors/primes.md`). Lighter than the majors — the suits do most of the structural work in the minors.

The structure and traditional mapping live in `references/tarot_structure.md` → "Prime Structure in the Minor Arcana"; the axis itself is `references/numeric_axis.md`. Face ranks (11–14) are built as in `ranks/questions.md`.
